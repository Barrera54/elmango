...
interface ProductoRow {
  Producto: string;
  Precio: string; // Podrías usar number si vas a hacer cálculos
  Cantidad: string; // Igual aquí, podría ser number
  Hora?: string; // Opcional si algunas filas no la tienen
}
